...
export default function Home() {
  const [totalsCount, setTotalCounts] = useState({ data: {} });
    ...
    <>
      <DefaultLayout>
        <div className="grid grid-cols-2 gap-4">
          <CardDataStats title="Total Boats" total={totalsCount.totalNumberOfBoats} rate="">
          ...
          <CardDataStats title="Total Captains" total={totalsCount.totalNumberOfCaptains} rate="">
