...
interface CaptainCounts {
  count: number;
}

interface BoatCounts {
  bcount: number;
}
...
export default function Home() {
  const [captainsCount, setCaptainsCount] = useState<number>(0);
    ...
    <>
      <DefaultLayout>
        <div className="grid grid-cols-2 gap-4">
          <CardDataStats title="Total Boats" total={boatCount.toString()} rate="">
          ...
          <CardDataStats title="Total Captains" total={captainsCount.toString()} rate="">
