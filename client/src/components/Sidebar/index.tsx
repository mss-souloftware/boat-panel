          ...
          <div>
            {getUserRole === 'CAPTAIN' ? (
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                <li>
                  <Link
                    href="/boat"
                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.endsWith("/boat") &&
                ...
                <li>
                  <Link
                    href="/boat/update"
                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("update") &&
                      "bg-graydark dark:bg-meta-4"
                      }`}
                  >
                    <svg
			...
			s8.169-18.21,18.21-18.21c10.041,0,18.21,8.17,18.21,18.21S261.101,188.982,251.06,188.982z"/>
                ...
                <li>
                  <Link
                    href="/addcaptain"
                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 mt-2 ${pathname.includes("/addcaptain") &&
                      "bg-graydark dark:bg-meta-4"
                      }`}
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
